      ...
      <section className="pt-48 pb-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground text-pretty leading-relaxed">{t.privacy.subtitle}</p>
            <p className="text-sm text-muted-foreground/60">{t.privacy.lastUpdated}</p>
          </motion.div>
        </div>
      </section>
